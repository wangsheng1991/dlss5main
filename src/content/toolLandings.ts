...
export const TOOL_LANDINGS: ToolLanding[] = [
  ...
  },
  {
    ...
    ctaNote: 'JPG, PNG and WebP · up to 20 MiB and 40 MP · transparent PNG at the original size',
    ...
    steps: [
      { name: 'Choose your image', text: 'Select a JPG, PNG or WebP up to 20 MiB and 40 megapixels. The preview stays in your browser until you submit.' },
    ...
    featureList: ['Transparent PNG output', 'Original pixel size kept', 'JPG, PNG and WebP input up to 20 MiB / 40 MP'],
    faqs: [
  ...
  },
  {
    ...
    ctaNote: 'JPG, PNG and WebP · up to 20 MiB and 40 MP · SVG output · long edge up to 2048 px',
    ...
    steps: [
      { name: 'Choose your image', text: 'Select a JPG, PNG or WebP up to 20 MiB and 40 megapixels — a logo, an icon or flat artwork at a sensible resolution.' },
    ...
    featureList: ['True SVG output (paths, not pixels)', 'Transparency preserved', 'JPG, PNG and WebP input up to 20 MiB / 40 MP'],
    faqs: [
