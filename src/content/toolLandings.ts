...
export const TOOL_LANDINGS: ToolLanding[] = [
  ...
  },
  {
    ...
    dashboardTool: 'enhance',
    language: 'en-US',
    title: 'Old Photo Restoration Online — Repair Faded Family Photos',
    description: 'Restore a faded, soft or compressed old photo online with AI enhancement. Preserve faces and the original composition while recovering contrast and texture.',
    eyebrow: 'AI photo restoration tool',
    heading: 'Old Photo Restoration',
    intro: 'Give a scanned or compressed family photo a cleaner, more readable version for sharing and archiving. The workflow asks the model to preserve faces and the original scene while repairing softness, contrast and compression damage.',
    ...
    keywords: ['old photo restoration', 'restore old photos online', 'AI photo restoration', 'restore faded photo', 'family photo enhancer', 'repair scanned photo'],
  ...
  },
  {
    ...
    dashboardTool: 'enhance',
    language: 'en-US',
    title: 'AI Headshot Enhancer Online — Clean Up a Professional Portrait',
    description: 'Create a cleaner professional headshot from your own portrait online. Improve sharpness, skin and hair texture while keeping your identity, expression and framing under review.',
    eyebrow: 'Professional portrait workflow',
    heading: 'AI Headshot Enhancer',
    intro: 'Turn a soft selfie or compressed portrait into a cleaner profile image for a résumé, team page or professional profile. The workflow improves the source portrait instead of replacing your face with a new identity.',
    ...
    keywords: ['ai headshot enhancer', 'professional headshot online', 'linkedin photo enhancer', 'resume photo enhancer', 'portrait quality enhancer'],
