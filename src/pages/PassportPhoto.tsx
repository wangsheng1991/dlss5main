...
export default function PassportPhoto() {
  ...
  return <>
    ...
    <main className="pt-28 sm:pt-32 pb-24 px-5 max-w-[1200px] mx-auto w-full">
      ...
      <section className="mt-16 max-w-4xl space-y-7" aria-labelledby="passport-definition-heading">
        <div><h2 id="passport-definition-heading" className="text-2xl font-headline font-bold text-white">What a passport photo maker does</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.definition}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">A repeatable local workflow</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.workflow}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Source quality still matters</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.quality}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Check the receiving authority</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.verification}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Why local processing matters</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.privacy}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Troubleshoot before printing</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.troubleshooting}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Know the limits</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.limitations}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Print at the documented size</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.printNotes}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Handle the downloaded file carefully</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.privacyNotes}</p></div>
        <div><h2 className="text-2xl font-headline font-bold text-white">Run the final checklist</h2><p className="mt-3 text-sm leading-relaxed text-zinc-300">{PASSPORT_PHOTO_LONG_FORM.checklist}</p></div>
      </section>
